...
from models.gpt import gpt_completion_fn, gpt_nll_fn, gemini_completion_fn
...
# -----------------------------------------------
# Each model is mapped to a function tgpt_completion_fnhat computes the continuous Negative Log-Likelihood
...
# 
# Args:
#   - input_arr (np.ndarray): Input time series (history) after data1 transformation.
#   - target_arr (np.ndarray): Ground truth series (future) after data1 transformation.
#   - settings (SerializerSettings): Serialization settings.
